...
function App() {
  ...
  return (
    <div className="flex flex-col overflow-hidden">
      ...
      {/* CONTENT */}
      <div className="flex flex-col mx-auto w-full justify-items-center text-center pb-6 fade-in -z-1">
        ...
        {/* SCHEDULE */}
        <div className='box-border px-8 schedule sm:bg-cover bg-contain max-w-screen w-screen'>
